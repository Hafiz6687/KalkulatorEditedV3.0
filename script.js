// =====================================================
// KALKULATOR AKTA KERJA 1955 (PERINGATAN TELAH DIREMOVE)
...
window.commitPendingRecord = function() {
    if (window.pendingRecord) {
        tambahRekodKeMaklumatGaji(
            window.pendingRecord.jenis,
            window.pendingRecord.namaPekerja,
            window.pendingRecord.majikan,
            window.pendingRecord.tempoh,
            window.pendingRecord.unikId
        );
        window.simpananHTMLGlobal = window.simpananHTMLGlobal || {};
        window.simpananHTMLGlobal[window.pendingRecord.unikId] = window.pendingRecord.html;
